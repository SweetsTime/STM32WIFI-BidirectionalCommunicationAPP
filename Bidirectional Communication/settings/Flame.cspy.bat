...
"D:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\common\bin\cspybat" "D:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\bin\armproc.dll" "D:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\bin\armjlink.dll"  %1 --plugin "D:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\bin\<libsupport_plugin>" --backend -B "--endian=little" "--cpu=Cortex-M3" "--fpu=None" "-p" "D:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\arm\CONFIG\debugger\ST\iostm32f10xxb.ddf" "--semihosting" "--device=STM32F10xxB" "-d" "jlink" "--drv_communication=USB0" "--jlink_speed=auto" "--jlink_initial_speed=32" "--jlink_reset_strategy=0,0" "--jlink_interface=SWD" 
